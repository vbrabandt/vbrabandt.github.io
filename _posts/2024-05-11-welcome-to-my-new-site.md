...
GitHub Pages with Jekyll allows me to write posts in simple Markdown, version control everything with Git, and use beautiful pre-made themes (like [Chirpy](https://github.com/cotes2020/jekyll-theme-chirpy/)) without touching HTML/CSS.
...
**Source Code:**  
Licensed under the [MIT License](https://github.com/vbrabandt/vbrabandt.github.io/blob/main/LICENSE), respecting and following the original [Chirpy theme](https://github.com/cotes2020/jekyll-theme-chirpy/) license.
